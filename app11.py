...
if choose == "modèle":
    ...
    st.markdown('<p class="font">Modèle mathématique de transmission de la peste entre hôtes et vecteurs</p>', unsafe_allow_html=True)
...
#################################################################################################################################
    ...
    ########################################################################################################################
    #st.title('Modèle mathématique de transmission de la peste entre rongeurs et puces')
